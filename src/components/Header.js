            ...
            <div className="container">
                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                    <ul className="navbar-nav ms-auto">
                        ...
                        <li className="nav-item">
                            <a className="nav-link fs-5 ms-3" onClick={() => setShowFavorites(!showFavorites)}><i className="bi bi-star-fill me-2">
                        ...
                        <li className="nav-item">
                            <a className="nav-link fs-5 ms-3" onClick={() => setShowOptionsMenu(!showOptionsMenu)}><i className="bi bi-three-dots-vertical me-2">
                            <div style={{ position: "relative", display: "inline-block"}}>
                                {showOptionsMenu && (
                                    <Card
                                    style={{
